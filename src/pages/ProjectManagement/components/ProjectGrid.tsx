                  ...
                  <div className="relative z-10 p-8 pb-0">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end">
                        <div
                          className={`rounded-full border px-4 py-1.5 text-[9px] font-black tracking-[0.2em] uppercase shadow-sm ${
                            isActive
                  ...
                  <div className="relative z-10 mt-auto p-8 pt-0">
                    ...
                    <div className="mt-6 flex items-center gap-3">
                      <button
                        ...
                        className={`group/status relative h-14 flex-1 overflow-hidden rounded-2xl text-[10px] font-black tracking-[0.2em] uppercase transition-all duration-300 ${
                          isActive
